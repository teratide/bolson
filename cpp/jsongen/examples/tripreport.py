...
schema_fields = [pa.field("timestamp", pa.date64(), False),
                 pa.field("timezone", pa.uint64(), False).with_metadata({"JSONGEN_MIN": "0", "JSONGEN_MAX": "1024"}),
                 pa.field("vin", pa.uint64(), False),
                 pa.field("odometer", pa.uint64(), False).with_metadata({"JSONGEN_MIN": "0", "JSONGEN_MAX": "1000"}),
                 pa.field("hypermiling", pa.bool_(), False),
                 pa.field("avgspeed", pa.uint64(), False).with_metadata({"JSONGEN_MIN": "0", "JSONGEN_MAX": "200"}),
                 pa.field("sec_in_band",
                          pa.list_(pa.field("item", pa.uint64(), False)
                                   .with_metadata({"JSONGEN_MIN": "0", "JSONGEN_MAX": "4192"}),
                                   12), False),
                 ...
                 pa.field("const_speed_miles_in_band",
                          pa.list_(pa.field("item", pa.uint64(), False).with_metadata(
                              {"JSONGEN_MIN": "0", "JSONGEN_MAX": "4192"}),
                              12), False),
                 ...
                 pa.field("sec_decel", pa.list_(
                     pa.field("item", pa.uint64(), False).with_metadata({"JSONGEN_MIN": "0", "JSONGEN_MAX": "4192"}),
                     10), False),
                 ...
                 pa.field("large_speed_var", pa.list_(
                     pa.field("item", pa.uint64(), False).with_metadata({"JSONGEN_MIN": "0", "JSONGEN_MAX": "4192"}),
                     13), False),
                 pa.field("accel_decel", pa.uint64(), False).with_metadata({"JSONGEN_MIN": "0",
                                                                            "JSONGEN_MAX": "4192"}),
                 pa.field("speed_changes", pa.uint64(), False).with_metadata({"JSONGEN_MIN": "0",
                                                                              "JSONGEN_MAX": "4192"})
                 ]
