...
output_schema = pa.schema([pa.field("timestamp", pa.utf8(), False).with_metadata({
                           ...
                           pa.field("timezone", pa.uint16(), False),
                           pa.field("vin", pa.uint16(), False),
                           pa.field("odometer", pa.uint16(), False),
                           pa.field("hypermiling", pa.uint8(), False),
                           pa.field("avgspeed", pa.uint16(), False),
                           pa.field("sec_in_band", pa.list_(pa.field("item", pa.uint16(), False)), False),
                           pa.field("miles_in_time_range", pa.list_(pa.field("item", pa.uint16(), False)), False),
                           pa.field("const_speed_miles_in_band", pa.list_(pa.field("item", pa.uint16(), False)), False),
                           pa.field("vary_speed_miles_in_band", pa.list_(pa.field("item",pa.uint16(), False)), False),
                           pa.field("sec_decel", pa.list_(pa.field("item", pa.uint16(), False)), False),
                           pa.field("sec_accel", pa.list_(pa.field("item", pa.uint16(), False)), False),
                           pa.field("braking", pa.list_(pa.field("item", pa.uint16(), False)), False),
                           pa.field("accel", pa.list_(pa.field("item", pa.uint16(), False)), False),
                           pa.field("orientation", pa.uint8(), False),
                           pa.field("small_speed_var", pa.list_(pa.field("item", pa.uint16(), False)), False),
                           pa.field("large_speed_var", pa.list_(pa.field("item", pa.uint16(), False)), False),
                           pa.field("accel_decel", pa.uint16(), False),
                           pa.field("speed_changes", pa.uint16(), False)
